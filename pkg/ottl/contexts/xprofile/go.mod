module github.com/open-telemetry/opentelemetry-collector-contrib/pkg/ottl/contexts/xprofile
...
replace github.com/open-telemetry/opentelemetry-collector-contrib/pkg/ottl => ../..
